...
exporter.asPNG = function (dygraph, img, userOptions) {
    "use strict";
    var canvas = this.asCanvas(dygraph, userOptions);
...
exporter.asCanvas = function (dygraph, userOptions) {
    ...
    utils.update(options, this.DEFAULT_ATTRS);
...
exporter.drawPlot = function (canvas, dygraph, options) {
    ...
    var labelsPluginDict = this.getPlugin(dygraph, 'ChartLabels Plugin');
    if (labelsPluginDict) {
...
exporter.putLabel = function (ctx, divLabel, options, font, color) {
    ...
    this.putText(ctx, left, top, divLabel, font, color);
};

/**
 * Draws a label Y1 rotated 90 degrees counterclockwise.
 */
exporter.putVerticalLabelY1 = function (ctx, divLabel, options, font, color, textAlign) {
    "use strict";
    if (!divLabel) {
        return;
    }
 ...
 */
exporter.putVerticalLabelY2 = function (ctx, divLabel, options, font, color, textAlign) {
    "use strict";
    if (!divLabel) {
        return;
    }
